...
int main() {
    ...
    inputFile = fopen("C:\\Users\\GEORGE OCHIERE\\Desktop\\ASSIGNMENT 2\\input.txt", "w+");//Your paths will be unique
    if (inputFile == NULL) {
    ...
    outputFile = fopen("C:\\Users\\GEORGE OCHIERE\\Desktop\\ASSIGNMENT 2\\output.txt", "a+");//remember the escape sequence
    if (outputFile == NULL) {
